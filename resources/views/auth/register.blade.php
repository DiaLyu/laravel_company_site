...
<html lang="en">
    ...
    <form method="POST" action="{{ route('register') }}" class="my-4">
        ...
        <div class="form-group mb-3">
            ...
            <input class="form-control" name="email" type="email" required="" id="email" placeholder="Enter your email">
        </div>
        ...
        <div class="form-group mb-3">
            ...
            <input class="form-control" name="password_confirmation" type="password" required="" id="password_confirmation" placeholder="Enter your password">
