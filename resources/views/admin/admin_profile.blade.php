    ...
    <div class="align-items-center">
        <div class="d-flex align-items-center">
            ...
            <div class="overflow-hidden ms-4">
                ...
                <span class="fs-15"><i class="mdi mdi-message me-2 align-middle"></i>Speaks: <span>Russian <span class="badge bg-primary-subtle text-primary px-2 py-1 fs-13 fw-normal">native</span> , English, Italian </span></span>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-md-6 mb-4">
                    <div class="">
                        ...
                        <p> I am a Web Developer with nearly three years of experience in commercial projects, primarily within the 1C-Bitrix ecosystem. My core expertise includes backend development, website performance optimization, administrative panel structuring in Bitrix, and template integration (Aspro, Intec).</p>
                        <p>Throughout my career, I have contributed to dozens of projects, including complex legacy Bitrix solutions with outdated modules and frameworks. I have successfully handled debugging, performance enhancements, and the implementation of new product features.</p>
                        <p>I am proficient in Git/GitLab, Linux command line, and familiar with CI/CD, Docker, and Kubernetes (experience gained through DevOps labs). During my studies at PNRPU (Bachelor’s), I built applications from scratch, including coursework on designing a large-scale database and a thesis project focused on developing a Geographic Information System.</p>
                        <p>Currently, I am advancing toward modern frameworks and product-focused development: learning Laravel, Go, and application architecture, while also deepening my understanding of neural network algorithms in Python. I am aiming to grow toward building scalable solutions, designing architecture, and integrating AI technologies into web products.</p>
                        <p>I am highly ambitious, responsible, and self-driven. Comfortable working both in a team and independently—taking ownership of tasks from requirements to delivery.
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4 col-lg-4">
                                <div class="profile-email">
                                    ...
                                    <a href="#" class="text-primary fs-14 text-decoration-underline">{{ $profileData->email }}</a>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-lg-4">
                                <div class="profile-email">
                ...
                <div class="col-md-6 col-sm-6 col-md-6 mb-4">
                     <div class="skills-details mt-3">
                        <h6 class="text-uppercase fs-13">Hard Skills</h6>

                        <div class="d-flex flex-wrap gap-2"> 
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">PHP</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">1C-Bitrix / Bitrix Framework</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Legacy Code Maintenance</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Website Performance Optimization</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Debugging & Troubleshooting</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">REST API / SOAP</span>
                        </div>

                    </div>
                     <div class="skills-details mt-3">
                        <h6 class="text-uppercase fs-13">Frameworks & Technologies</h6>

                        <div class="d-flex flex-wrap gap-2"> 
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Laravel</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Go (Golang)</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Python (Neural Network Fundamentals)</span>
                        </div>

                    </div>
                    <div class="skills-details mt-3">
                        <h6 class="text-uppercase fs-13">DevOps & Infrastructure</h6>

                        <div class="d-flex flex-wrap gap-2"> 
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Git / GitLab</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Linux CLI</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">CI/CD</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Docker</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Kubernetes (basic / lab experience)</span>
                        </div>

                    </div>
                     <div class="skills-details mt-3">
                        <h6 class="text-uppercase fs-13">Databases</h6>

                        <div class="d-flex flex-wrap gap-2"> 
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">MySQL</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">PostgreSQL</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Database Design</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Query Optimization</span>
                        </div>

                    </div>
                    <div class="skills-details mt-3">
                        <h6 class="text-uppercase fs-13">Tools & Workflow</h6>

                        <div class="d-flex flex-wrap gap-2"> 
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Composer</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Nginx / Apache</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Figma</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Query Optimization</span>
                        </div>

                    </div>
                    <div class="skills-details mt-3">
                        <h6 class="text-uppercase fs-13">Other Technical Skills</h6>

                        <div class="d-flex flex-wrap gap-2"> 
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">System Architecture Fundamentals</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">OOP / SOLID</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Clean Code Principles</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Version Control Workflow</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">API Integration</span>
                        </div>

                    </div>
                    <div class="skills-details mt-3">
                        <h6 class="text-uppercase fs-13">Soft Skills</h6>

                        <div class="d-flex flex-wrap gap-2"> 
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Responsibility</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Self-Management</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Analytical Thinking</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Problem-Solving</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Team Collaboration</span>
                            <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Ownership mindset</span>
                        </div>
